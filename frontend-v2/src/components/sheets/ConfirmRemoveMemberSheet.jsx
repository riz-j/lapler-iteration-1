...
export default function ConfirmRemoveMemberSheet({ onClick, onClose, selectedUserId, selectedUserFirstName, selectedUserLastName }) {
      ...
      >
        ...
        >
            <form onSubmit={handleLeaveProject} className="flex flex-col gap-3 font-semibold">
              <h1 className="text-lg">Are you sure you want to remove {selectedUserFirstName} {selectedUserLastName} from the project?</h1>
